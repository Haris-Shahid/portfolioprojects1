...
window.tmLivechatLoaded=!0}b.widget("tm.livechat",{version:"1.0.1",options:{actionUrl:"",title:"Need a Website?",startChatTitle:"Start Chat",content:"<p>Hi! Let me help you choose the right <b>premium</b> template.</p><p>What kind of website are you planning to make?<p>",mainColor:"",secondaryColor:"",
...
this._blinkInterval=this._isLiveChatOpened=!1},_createOpenBtn:function(){this.element.append('\t\t\t<div class="tm-livechat-close">\t\t\t    <div class="tm-livechat-header">\t\t\t        <p class="tm-livechat-title">'+this.options.title+'</p>\t\t\t        <a href="#open" class="tm-livechat-btn tm-livechat-btn-open"></a>\t\t\t    </div>\t\t\t</div>\t\t\t')},_createForm:function(){this.element.append('\t\t\t\t<div class="tm-livechat-dialog tm-livechat-float-'+this.options.dialogFloat+'">\t\t\t\t\t<form method="POST" action="'+this.options.actionUrl+'" class="tm-livechat-form">\t\t\t\t\t    <div class="tm-livechat-header">\t\t\t\t\t        <p class="tm-livechat-title">'+this.options.title+'</p>\t\t\t\t\t        <a href="#close" class="tm-livechat-btn tm-livechat-btn-close"></a>\t\t\t\t\t    </div>\t\t\t\t\t    <div class="tm-livechat-content">\t\t\t\t\t\t    <div class="tm-livechat-text">'+this.options.content+ 
'<input autofocus type="text" name="nick" id="nick" class="chat-name" placeholder="your name" value="" required>'
+'<input type="email" name="email" id="email" class="chat-mail" placeholder="your email address" value="" required>'
...
+'<input type="text" name="templateId" id="templateId" value="'+this.options.templateId+'" style="display:none">'
   +'</div>\t\t\t\t\t        <input type="submit" class="tm-livechat-btn-start" value="'+this.options.startChatTitle+
...
b(document).ready(function(){b(".tm-livechat").livechat()})})(jQuery);